...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-gradient-to-r from-emerald-500/10 via-teal-500/5 to-indigo-500/10 rounded-2xl p-4 border border-emerald-100/90 flex items-center gap-3.5 shadow-2xs">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-emerald-600 to-teal-500 text-white flex items-center justify-center shadow-xs flex-shrink-0">
        ...
        <div>
          ...
          <p className="text-[11px] text-slate-500 font-medium leading-relaxed mt-0.5">
            Documents are safely encrypted and accessible only by our 4 approved family members.
          </p>
        </div>
      </div>
    </div>
